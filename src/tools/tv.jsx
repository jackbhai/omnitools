...
const Tile = ({ c, onOpen }) => (
  <button className="tile tv-tile" onClick={() => onOpen(c)}>
    ...
    <small>
      ...
      {TV.recentlyFailed(c.id) ? ' · was down' : ''}
    </small>
  </button>
);
...
export function LiveTV() {
  ...
  const nextChannel = () => {
    ...
    const nxt = rest.find((c) => !TV.recentlyFailed(c.id)) || rest[0];
